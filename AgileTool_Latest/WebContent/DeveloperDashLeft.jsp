...
<a href="DeveloperDashRight.jsp" target="project"><span class="glyphicon glyphicon-folder-open" style="padding-right:10px;"></span>My Work</a><br />
<a href="ScrumTeam.jsp" target="project"><span class="glyphicon glyphicon-user" style="padding-right:10px;"></span>Scrum Team</a><br />
